...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView arrowBackToLandingScreen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonMusicAlbumFragment = findViewById(R.id.buttonMusicAlbum);
        buttonMusicFolderFragment = findViewById(R.id.buttonMusicFolder);
        buttonMusicDownloadFragment = findViewById(R.id.buttonDownloadMusic);
        buttonMusicUserProfileFragment = findViewById(R.id.buttonUserProfile);

        arrowBackToLandingScreen = findViewById(R.id.BackToLandingScreen);
        ...
        arrowBackToLandingScreen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
